  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fdf2f8] text-[#2a0f1d]">
      <section className="mx-auto min-h-screen max-w-[1180px] px-4 py-8 sm:px-6">
        <div className="rounded-lg border bg-white border-pink-950/10 overflow-hidden"><div className="border-b border-current/10 p-5"><p className="text-xs font-black uppercase opacity-50">Personal agent</p><h1 className="mt-3 text-4xl font-black sm:text-6xl">AI Career Coach Agent</h1><p className="mt-4 leading-8 opacity-65">A career coach agent starter for positioning, interview prep, and professional planning.</p></div><div className="grid gap-0 lg:grid-cols-[1fr_360px]"><div className="p-5"><form className="space-y-3" onSubmit={submit}>
              <textarea
              ...
              <button
                ...
                type="submit"
              >
                {isRunning ? "Running..." : "Ask companion"}
              </button>
